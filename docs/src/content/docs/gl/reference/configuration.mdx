...
description: Unha descrición xeral de tódalas opcións de configuración que admite Starlight.
---

## Configurar a integración `starlight`

Starlight é unha integración construida sobre o framework [Astro](https://astro.build). Podes configuralo teu proxecto dentro do arquivo de configuración `astro.config.mjs`:
